...
func TestGetAllPublicProfileUsers(t *testing.T) {
	...
	for _, v := range testCases {
		t.Run(v.TestCaseName, func(t *testing.T) {
			_, err := NewUserRepo(dbConn, redisClient).GetAllPublicProfileUsers(v.QueryParams)
...
func TestGetMyDetails(t *testing.T) {
	...
	for _, v := range testCases {
		t.Run(v.TestCaseName, func(t *testing.T) {
			_, err := NewUserRepo(dbConn, redisClient).GetMyDetails(v.UserID)
			assert.Equal(t, v.Expected, err)
		})
	}
}
...
func TestUpdateUserProfile(t *testing.T) {
	...
	for _, v := range testCases {
		t.Run(v.TestCaseName, func(t *testing.T) {
			...
			err := NewUserRepo(dbConn, redisClient).UpdateUserProfile(v.UserID, userToUpdate)
			assert.Equal(t, v.Expected, err)
		})
	}
}
...
func TestSendOTPToUser(t *testing.T) {
	...
	for _, v := range testCases {
		t.Run(v.TestCaseName, func(t *testing.T) {
			...
			_, err := NewUserRepo(dbConn, redisClient).SendOTPToUser(email, 4099, time.Now().Add(5*time.Minute))
			assert.Equal(t, v.Expected, err)
		})
	}
}
...
func TestVerifyOTP(t *testing.T) {
	...
	for _, v := range testCases {
		t.Run(v.TestCaseName, func(t *testing.T) {
			...
			err := NewUserRepo(dbConn, redisClient).VerifyOTP(otpFromUser)
			assert.Equal(t, v.Expected, err)
		})
	}
}
...
func TestResetUserPassword(t *testing.T) {
	...
	for _, v := range testCases {
		t.Run(v.TestCaseName, func(t *testing.T) {
			...
			err := NewUserRepo(dbConn, redisClient).ResetUserPassword(userEmailPassword)
			assert.Equal(t, v.Expected, err)
		})
	}
}
